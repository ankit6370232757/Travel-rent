...
export default function AdminRequests({ requests = [], onHandleAction, forceType }) {
...
useEffect(() => {
  ...
  const filteredResults = useMemo(() => {
    ...
    return result;
  }, [requests, activeSubView, query, forceType]);
    ...
    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
      ...
      <TopHeaderRow>
        <SearchBox>
          ...
          <input 
            type="text" 
            placeholder={`Search ${forceType.toLowerCase()}s...`} 
            value={query}
      ...
      <StatsHeader>
        <StatCard>
          <span>{activeSubView} {forceType}S</span>
