...
import {
  ...
  Sparkles, ShieldCheck, Megaphone, LogOut, AlertTriangle
...
const LogoutButton = styled.button`
  ...
  &:hover { background: #ff2e44; transform: translateY(-2px); box-shadow: 0 5px 15px rgba(255, 71, 87, 0.3); }
    ...
    <LayoutWrapper>
          ...
          >
            ...
            >
              ...
              <ModalContent>
                ...
                <ConfirmButton onClick={handleCloseModal}>Got it, thanks!</ConfirmButton>
          ...
          >
            ...
            >
              ...
              <ModalContent style={{ padding: '40px 30px' }}>
                ...
                <div style={{ background: 'rgba(255, 71, 87, 0.1)', width: '60px', height: '60px', borderRadius: '50%', display: 'flex', alignItems: 'center', justify_content: 'center', margin: '0 auto 20px', color: '#ff4757' }}>
                ...
                <p>Are you sure you want to log out? You will need to enter your credentials again to access your portfolio.</p>

                <LogoutActions>

                  <CancelButton onClick={() => setShowLogoutModal(false)}>Stay Here</CancelButton>
      ...
      <SidebarContainer $isOpen={isSidebarOpen}>
        ...
        <Sidebar
          ...
          onLogout={() => setShowLogoutModal(true)} // 🟢 TRIGGER MODAL INSTEAD OF LOGOUT
